...
# having an flask project in which i am using openai to extreact measurements now i have stored api_key in .env file and 
# have to use in llm_utils.py file nwhre i declared openapi key and loading using  dotenv but when i commit or push code to 
# github it gaves errors like youre pushing scret data, keys etc hwo to resolve this error alos have file .gitigone where i
